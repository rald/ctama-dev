/*
* main.c - Showcase application utilizing standardized SDL_GameController configuration layout with GUID printer and font.h
*/
...
int main(int argc, char* argv[]) {
    ...
    if (!mysdl_init(&app, "MySDL2 Font Showcase", SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_SCALE)) {
    ...
    while (mysdl_poll(&app)) {
        ...
        // Draw text using font.h
        mysdl_draw_string(&app, 10, 10, "MYSDL2 + FONT.H", SWEETIE_16_PALETTE[0x0B]);
        mysdl_draw_string(&app, 10, 22, "USE WASD/ARROWS TO MOVE", SWEETIE_16_PALETTE[0x04]);
